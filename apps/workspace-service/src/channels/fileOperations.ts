...
export class FileOperations {
  ...
  private async listTree(
    request: FileListTreeRequest
  ): Promise<FileListTreeResponse | FileErrorResponse> {
  ...
  ): Promise<FileDeleteResponse | FileErrorResponse> {
    const { requestId, path } = request;
    const fullPath = this.resolvePath(path);
  ...
  ): Promise<FileRenameResponse | FileErrorResponse> {
